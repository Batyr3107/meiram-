@echo off
REM ============================================
REM ShopMobile - APK Build Script (Custom Flutter Path)
REM ============================================
...
set "FLUTTER_PATH=C:\Users\JusanUser\Downloads\flutter_windows_3.29.0-stable\flutter\bin"
set "FLUTTER_BIN=%FLUTTER_PATH%\flutter.bat"

REM Check if Flutter exists at custom path
if not exist "%FLUTTER_BIN%" (
    echo [ERROR] Flutter not found at: %FLUTTER_PATH%
    echo.
    echo Please check Flutter SDK location.
    echo Expected: C:\Users\JusanUser\Downloads\flutter_windows_3.29.0-stable\flutter\bin\flutter.bat
    echo.
    echo If Flutter is in a different location, edit this script and update FLUTTER_PATH.
    echo.
    pause
    exit /b 1
)
...
call "%FLUTTER_BIN%" analyze --no-fatal-infos
if %errorlevel% neq 0 (
